...
setup_tools() {
    ...
    brew install alacritty clang-format cmake deno doxygen git git-lfs gnu-sed graphviz htop llvm neovim ninja python ripgrep sox tmux tree tree-sitter watch wget
