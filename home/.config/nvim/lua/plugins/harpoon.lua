return {
  ...
  config = function ()
    ...
    vim.keymap.set("n", "<leader>hk", function() harpoon:list():select(2) end, { desc = "[h]arpoon file 2" })
    vim.keymap.set("n", "<leader>hl", function() harpoon:list():select(3) end, { desc = "[h]arpoon file 3" })
