...
local function rust_on_attach(client, bufnr)
  ...
  keymap("n", "<leader>la", function() vim.cmd.RustLsp("codeAction") end, 'code [a]ction')
  keymap("n", "<leader>ld", function() vim.cmd.RustLsp("renderDiagnostic") end, "open floating [d]iagnostic message")
  keymap("n", "<s-J>", function() vim.cmd.RustLsp("joinLines") end, "open floating [d]iagnostic message")
end
