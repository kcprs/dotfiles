...
function M.setup_basic()
    ...
    map("v", "<leader>p", "pgvy", { desc = "Paste over selection without yanking it" })
...
function M.lsp_common(buffer)
    ...
    map_with_leader_l("n", "i", function()
        vim.lsp.inline_completion.enable(not vim.lsp.inline_completion.is_enabled())
        vim.notify("Inline completion " .. (vim.lsp.inline_completion.is_enabled() and "enabled" or "disabled"), vim.log.levels.INFO)
    end, { desc = "LSP: toggle [i]nline completion" })
    map("i", "<C-.>", function()
        vim.lsp.inline_completion.get()
    end, { desc = "LSP: Accept current inline completion" })
    map("i", "<C-,>", function()
        vim.lsp.inline_completion.select()
    end, { desc = "LSP: Next inline completion" })
